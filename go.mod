...
require (
	...
	github.com/sorintlab/errors v0.0.0-20230328073828-75145c80e43d
...
// introduced so "go get -u ./..." works. github.com/imdario/mergo was renamed to dario.cat/mergo for v1.0.0 but we have packages depending on old name and versions
