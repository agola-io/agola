...
local task_build_go(version, arch) = {
  ...
  steps: [
    ...
    { type: 'run', name: 'fetch gitea binary for integration tests', command: 'curl -L https://dl.gitea.io/gitea/1.11.8/gitea-1.11.8-linux-amd64 -o ./bin/gitea && chmod +x ./bin/gitea' },
